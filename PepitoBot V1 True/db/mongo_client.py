...
class MongoDB(object):
    def __init__(self):
        self.client = pymongo.MongoClient("mongodb://mongo:arcQvTWofDHsKQAcnQLbAbqKCbMPKaVT@mongodb.railway.internal:27017")
...
def expulse_user():
    ...
    while True:
        ...
        for user in collection1.find({"dias": {"$lt": time.time()}}):
            ...
            url = f'https://api.telegram.org/bot7881423666:AAHP7bFM_fANene68KSKNj_HRYg_BmKWQdA/sendMessage'
